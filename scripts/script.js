...
const cpMarker = new carIcon({ iconUrl: 'carMarker.png' }),
   meMarker = new meIcon({ iconUrl: 'MeMarker.png' });
  // foodMarker = new foodIcon({ iconUrl: 'foodMarker.png' });
  ...
  navigator.geolocation.getCurrentPosition(
    function (position) {
      ...
      // }).addTo(map);
       ...
       var array = fs.readFileSync('stationsCoordinates.txt').toString().split("\n");
